...
const features = [
  {
    icon: <FaCode className="text-[#e34f26]" />, // HTML/Frontend tone
    title: "Frontend Development",
    desc: "Skilled in HTML, CSS, JavaScript, React.js and Tailwind CSS to build responsive and modern user interfaces.",
  },
  {
    icon: <FaTachometerAlt className="text-[#0284c7]" />, // Performance/CSS blue tone
    title: "Performance Optimization",
    desc: "Improving website speed and performance by optimizing code, images, and ensuring fast loading user experience.",
  },
  {
    icon: <FaMobileAlt className="text-[#f59e0b]" />, // JS yellow tone
    title: "Responsive Design",
    desc: "Creating fully responsive websites that work smoothly on mobile, tablet, and desktop devices.",
  },
  {
    icon: <FaProjectDiagram className="text-[#06b6d4]" />, // React cyan tone
    title: "Project Development",
    desc: "Developed projects like Cosmetic Website and Eduma Online Courses platform with modern UI and functionality.",
  },
  {
    icon: <FaGlobe className="text-[#22c55e]" />, // Node green tone
    title: "Web Development",
    desc: "Capable of building complete web applications with modern technologies focusing on performance and user experience.",
  },
  {
    icon: <FaLaptopCode className="text-[#f97316]" />, // Firebase orange tone
    title: "UI & User Experience",
    desc: "Focused on clean UI design and user-friendly experience to improve usability and engagement.",
  },
];
  ...
  return (
    ...
    <section ref={sectionRef} className="py-20 md:px-10 px-5 overflow-hidden bg-[#050c1a]">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Heading */}
        <div
          className="transform transition-all duration-700 ease-out mb-14"
          style={{
            opacity: visibleItems.length > 0 ? 1 : 0,
            transform: visibleItems.length > 0 ? "translateY(0)" : "translateY(30px)",
          }}
        >
          <p className="text-orange-500 tracking-widest uppercase text-sm mb-2 font-semibold">
            Feature
          </p>
        ...
        {/* Grid - Cards matching the new image UI */}
        <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 gap-10">
          {features.map((item, index) => (
            <div
              key={index}
              data-index={index}
              className="feature-card group relative p-8 min-h-[280px] rounded-2xl flex flex-col justify-center items-center transition-all duration-500 transform"
              style={{
              ...
              // Hover effect: Glow thoda aur intense ho jayega jaisa screen par lag raha hai
              onMouseEnter={(e) => {
            ...
            >
              ...
              <div className="flex flex-col items-center text-center w-full">
                ...
                {/* Icon Box - Centered like the technology logos */}
                <div className="text-5xl mb-4 transform transition-transform duration-300 group-hover:scale-110">
                  {item.icon}
                </div>

                {/* Title - Bold white text directly below the icon */}
                <h3 className="text-xl font-bold text-white mb-3 tracking-wide">
                  {item.title}
                </h3>

                {/* Description - Neat text matching alignment */}
