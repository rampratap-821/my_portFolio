...
const blogs = [
  {
    img: "https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=500&auto=format&fit=crop&q=60",
    category: "FRONTEND",
    time: "3 min read",
    title: "How I Built Fully Responsive Websites using HTML, CSS & Tailwind",
  },
  {
    img: "https://plus.unsplash.com/premium_photo-1720274013734-b172a1c8c31e?w=500&auto=format&fit=crop&q=60",
    category: "REACT JS",
    time: "5 min read",
    title: "Creating Modern UI with React.js using Component-Based Design",
  },
  {
    img: "https://images.unsplash.com/photo-1758876020491-9560594ec362?w=500&auto=format&fit=crop&q=60",
    category: "PROJECT",
    time: "4 min read",
    title: "Developing Online Courses Platform with React & Tailwind",
  },
...
const Blog = () => {
  return (
    <section className="w-full py-16 bg-[#070b14] border-b border-gray-900 text-white font-sans">
      <div className=" px-7">
        
        {/* Top Text */}
        <p className="text-center text-sm tracking-widest text-[#f05423] uppercase pb-3 font-semibold">
          Visit my blog and keep your feedback
        </p>

        {/* Heading */}
        <h2 className="text-center text-4xl md:text-5xl font-bold text-gray-100 pb-20 tracking-wide">
          My Blog
        </h2>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
          {blogs.map((blog, index) => (
            <div
              key={index}
              /* border-[#82db26]: आपकी इमेज जैसा परफेक्ट नियॉन ग्रीन बॉर्डर
                shadow-[0_0_20px_rgba(130,219,38,0.35)]: बॉर्डर के चारों तरफ फैली हुई स्थिर हरी रोशनी (Glow Effect)
                hover:-translate-y-2: कर्सर ले जाने पर कार्ड बहुत स्मूथली थोड़ा ऊपर उठेगा
              */
              className="relative rounded-2xl border-2 border-[#82db26] bg-[#0a0e17] overflow-hidden cursor-pointer 
                         shadow-[0_0_20px_rgba(130,219,38,0.35)] transition-all duration-300 transform hover:-translate-y-2"
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  {/* Vibrant Orange Category */}
                  <span className="text-[#f05423] text-xs font-bold tracking-widest uppercase">
                    {blog.category}
                  </span>
                ...
                {/* Blog Title */}
                <h3 className="text-lg font-bold text-gray-200 leading-snug">
                  {blog.title}
                </h3>
              </div>
